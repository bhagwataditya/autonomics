...
#'        By default coefficient k represents the difference of level k to level 1.                   \cr
...
#'        All of these functions except one are unit-scaled (coefvalue = 1 means difference = 1)      \cr
#'                                                                                                    \cr
