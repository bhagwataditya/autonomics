...
#' @importFrom assertive     assert_all_are_finite   assert_all_are_in_range
...
#' @importFrom stats         aggregate    approxfun   as.formula   lowess
#' @importFrom stats         median   model.matrix   na.exclude   rnorm
#' @import     stringi
