...
```{r, echo = FALSE, fig.width = 6, fig.height = 6, out.width = '85%', out.height = '85%', message = FALSE}
require(data.table)
require(ggplot2)
require(autonomics)
dt <- data.table(
    ...
    label = c('', 'read_affy', 'read_proteingroups', 'read_phosphosites', 
              ...
              'read_rnaseq_counts'), 
    molecule = c('', 'microarray', 'maxquant', 'maxquant', 'diann', 'epitope', 
                 'metabolite', 'rnaseq'))
ggplot(dt) + 
ylim(0, 2) + 
...
In this case **`r n[[5]]` proteingroups** (out of `r n[[1]]` identified) were retained for  analysis, after applying the following filters:
