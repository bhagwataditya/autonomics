...
object.rnaseq        <- read_rnaseq_counts(file = file.rnaseq,        plot = FALSE)
object.proteingroups <- read_proteingroups(file = file.proteingroups, plot = FALSE)
object.phosphosites  <- read_phosphosites( file = file.phosphosites, proteinfile = file.proteingroups, plot = FALSE)
object.diann         <- read_diann(        file = file.diann,         plot = FALSE)
object.somascan      <- read_somascan(     file = file.somascan,      plot = FALSE)
object.metabolon     <- read_metabolon(    file = file.metabolon,     plot = FALSE)
```
