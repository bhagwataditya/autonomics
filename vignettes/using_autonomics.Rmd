...
```{r}
  ...
  cpm = FALSE, voom = FALSE, limma = TRUE, verbose = FALSE, plot=FALSE))[, -1])

  colSums(extract_limma_summary(read_rnaseq_counts(file,  # log2 cpm
  cpm = TRUE,  voom = FALSE, limma = TRUE, verbose = FALSE, plot=FALSE))[, -1])

  colSums(extract_limma_summary(read_rnaseq_counts(file,  # log2 cpm + voom
  cpm = TRUE,  voom = TRUE,  limma = TRUE, verbose = FALSE, plot=FALSE))[, -1])
```
...
object <- read_metabolon(
            ...
            pca = TRUE, limma = TRUE, block = 'SUB', plot = TRUE)
```
...
object <- read_somascan(
            ...
            pca = TRUE, limma = TRUE, block = 'Subject_ID', plot = TRUE)
