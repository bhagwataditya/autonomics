...
# log2counts
  object <- read_rnaseq_counts(file, 
       cpm = FALSE, voom = FALSE, test = 'limma', verbose = FALSE, plot = FALSE)
  colSums(extract_test_summary(object, 'limma')[, -1])
# log2cpm
  object <- read_rnaseq_counts(file,
       cpm = TRUE,  voom = FALSE, test = 'limma', verbose = FALSE, plot=FALSE)
  colSums(extract_test_summary(object, 'limma')[, -1])
# log2cpm + voom
  object <- read_rnaseq_counts(file,  # log2 cpm + voom
       cpm = TRUE,  voom = TRUE,  test = 'limma', verbose = FALSE, plot=FALSE)
  colSums(extract_test_summary(object, 'limma')[, -1])
```
...
object <- read_metabolon(
            ...
            pca = TRUE, test = 'limma', block = 'SUB', plot = TRUE)
```
...
object <- read_somascan(
            ...
            pca = TRUE, test = 'limma', block = 'Subject_ID', plot = TRUE)
```
