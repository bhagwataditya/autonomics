...
object <- read_proteingroups(file = file, plot = TRUE)
```
...
object <- read_metabolon(file,  subgroupvar = 'SET', block = 'SUB', plot = TRUE)
```
...
object <- read_somascan(file, block = 'Subject_ID', plot = TRUE)
```
