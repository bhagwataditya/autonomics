...
test_that('`read_maxquant_proteingroups(billing19)` reads abundances', {
...
test_that('`read_maxquant_proteingroups(billing19)` reads uniprots', {
...
context('read_maxquant_proteingroups: fukuda20')
